...
Sources:
  - mcad-tx.org
  - mvbalaw.com/tax-sales/montgomery-county/
  - mctx.org tax office
"""
import logging
import httpx
...
def scrape_mvba() -> List[Dict]:
    url = "https://mvbalaw.com/tax-sales/montgomery-county/"
    try:
        html = fetch_html(url)
        ...
        logging.info(f"[montgomery/mvba] {len(records)} records")
        return records
    except Exception as e:
        logging.warning(f"[montgomery/mvba] failed: {e}")
        return []
